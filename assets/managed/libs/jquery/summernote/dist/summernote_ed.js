...
(function (factory) {
    ...
    var button = renderer.create('<button type="button" class="note-btn btn-sm" tabindex="-1">', function ($node, options) {
                    ...
                    children: [
                        ...
                        ui.dropdown({
                            items: [
                                ...
                                '  <div>',
                                '    <button type="button" class="note-color-reset " data-event="backColor" data-value="inherit">',
