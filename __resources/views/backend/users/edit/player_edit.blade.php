    ...
    <div class="col-lg-8 col-md-8 col-sm-12">
        ...
        <div class="form-group row">
            <div class="col-sm-6">
                ...
                <input type="date" value="{{ old('dob', $UserPersonal->dob) }}"
                       class="form-control " id="dob"
                       placeholder="Date Of Birth" name="dob" max="<?php echo date('Y-m-d'); ?>" onkeydown="return false" required>
                @if ($errors->has('dob'))
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-sm-8">
                    <select class="form-control" id="organizational_name" name="organizational_name" required>
                        ...
                        <option value="{{ 'Recreational' }}" <?php echo (isset($UserProfessional->organizational_name) && $UserProfessional->organizational_name == 'Recreational') ? ' selected' : ''; ?> >
                            {{ 'Recreational '  }}</option>
                        <option value="{{ 'Travel' }}" <?php echo (isset($UserProfessional->organizational_name) && $UserProfessional->organizational_name == 'Travel') ? ' selected' : ''; ?> >
                            {{ 'Travel '  }}</option>
                    </select>
