...
$data = [
	...
	'b1_route' => 'sessions.index',
	 ...
	 'show_buttons' => 1,
	'btn_dashboad_route' => 'sessions.create'

];
if($records_exists == 1){
	$data['btn_filters'] = 1;
}
if(Auth::user()->can('sessions-add') || Auth::user()->can('all')){
	$data['btn_add_route'] = 'sessions.create';
}
?>
...
?>
    var oTable = $('#myDataTableHistory').DataTable(
    {
        ...
        url: "{!! route('sessions.history.datatable') !!}",
