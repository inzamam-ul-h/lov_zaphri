...
<head>
    ...
    <link rel="stylesheet" href="{{ chat_asset_url('assets/icheck/skins/all.css') }}">
    <link rel="stylesheet" href="{{ chat_asset_url('css/datetime-picker.css') }}"/>
    ...
    @if(getLoggedInUser()->is_subscribed)
        @include('chat.layouts.one_signal')
    @endif
    @livewireStyles
    @routes
    <link href="{{ portal_managed_url('font-awesome/css/font-awesome.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ chat_asset_url('css/emojionearea.min.css') }}">
    @yield('page_css')
    <link rel="stylesheet" href="{{ chat_asset_url('assets/css/style.css') }}">
    @yield('css')
...
<div class="app-body">
    ...
    @include('chat.layouts.change_password')
    <main class="main">
...
<!-- jQuery 3.1.1 -->
<script src="{{ chat_asset_url('messages.js') }}"></script>
...
<script src="{{ chat_asset_url('assets/js/sweetalert2.all.min.js') }}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.2/js/select2.min.js"></script>
<script src="{{ chat_asset_url('js/moment.min.js') }}"></script>
<script src="{{ chat_asset_url('assets/js/moment-with-locales.min.js') }}"></script>
<script src="{{ chat_asset_url('js/moment-timezone.min.js') }}"></script>
<script src="{{ chat_asset_url('assets/icheck/icheck.min.js') }}"></script>
<script src="https://www.jsviews.com/download/jsviews.min.js"></script>
<script src="{{ chat_asset_url('js/emojionearea.js') }}"></script>
<script src="{{ chat_asset_url('assets/js/emojione.min.js') }}"></script>
<script type="text/javascript" src="{{ chat_asset_url('js/datetime-picker.js') }}"></script>
<script src="{{ chat_asset_url('js/bootstrap-datetimepicker.min.js') }}"></script>
...
<script src="{{ chat_asset_url('assets/js/app.js') }}"></script>
<script src="{{ chat_asset_url('assets/js/custom.js') }}"></script>
<script src="{{ chat_asset_url('assets/js/notification.js') }}"></script>
<script src="{{ chat_asset_url('assets/js/set_user_status.js') }}"></script>
<script src="{{ chat_asset_url('assets/js/set-user-on-off.js') }}"></script>
<script src="{{chat_asset_url('assets/js/profile.js')}}"></script>
@livewireScripts
@stack('scripts')
@yield('scripts')
</html>
