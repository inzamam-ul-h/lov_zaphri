...
$table_url = (isset($table_url)) ? $table_url : route('dashboard.player_upc_sessions_datatable');
?>
<div class="table table-striped table-hover">
    <input type="hidden" class="call_player_datatable" data-table_id="<?php echo $table_id;?>" data-ajax_url="<?php echo $table_url;?>">
