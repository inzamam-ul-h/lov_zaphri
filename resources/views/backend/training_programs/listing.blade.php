...
if(Auth::user()->can('training-programs-add') || Auth::user()->can('all')){
	$data['btn_add_route'] = 'training-programs.create';
}
?>
...
jQuery(document).ready(function(e)
{
	...
	?>
		var oTable = $('#myDataTable').DataTable(
		{
			...
			ajax:
			{
				url: "{!! route('training-programs.datatables') !!}",
				data: function (d)
				{
					d.title = $('#s_title').val();
