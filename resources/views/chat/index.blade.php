...
@endsection
@section('page_css')
    <link rel="stylesheet" href="{{ chat_asset_url('css/dropzone.css') }}">
    <link rel="stylesheet" href="{{ chat_asset_url('css/yBox.min.css') }}">
    <link rel="stylesheet" href="{{ chat_asset_url('assets/css/video-js.css') }}">
    <link rel="stylesheet" href="{{ chat_asset_url('assets/css/new-conversation.css') }}">
@endsection
@section('content')
                                    ...
                                    <div
                                        ...
                                        <i class="nav-icon group-icon color-green remove-tooltip" data-bs-toggle="tooltip"
                                           ...
                                           title="{{ __('messages.create_new_group') }}"><img
                                                    src="{{chat_asset_url('assets/icons/group.png')}}" width="33" height="33"></i>
                                    </div>
                            ...
                            <div class="chat__people-wrapper-button d-flex align-items-center" data-bs-toggle="modal"
                                ...
                                <i class="nav-icon remove-tooltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                   title="{{ __('messages.new_conversation') }}"><img
                                        src="{{chat_asset_url('assets/icons/bubble-chat.png')}}" width="30" height="30"></i>
                            </div>
...
@endsection
@section('page_js')
    <script src="{{ chat_asset_url('js/dropzone.min.js') }}"></script>
    <script src="{{ chat_asset_url('js/directive.min.js') }}"></script>
    <script src="{{ chat_asset_url('js/yBox.min.js') }}"></script>
    <script src="{{ chat_asset_url('assets/js/video.min.js') }}"></script>
@endsection
@section('scripts')
    <!--custom js-->
    <script>
        ...
        /** Icons URL */
        let pdfURL = '{{ chat_asset_url('assets/icons/pdf.png') }}'
        let xlsURL = '{{ chat_asset_url('assets/icons/xls.png') }}'
        let textURL = '{{ chat_asset_url('assets/icons/text.png') }}';
        let docsURL = '{{ chat_asset_url('assets/icons/docs.png') }}'
        let videoURL = '{{ chat_asset_url('assets/icons/video.png') }}'
        let youtubeURL = '{{ chat_asset_url('assets/icons/youtube.png') }}'
        let audioURL = '{{ chat_asset_url('assets/icons/audio.png') }}'
        let zipURL = '{{ chat_asset_url('assets/icons/zip.png') }}'
    ...
    <script src="{{ chat_asset_url('assets/js/chat.js') }}"></script>
@endsection
